-file("/home/user/.kerl/erlang/27.2/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 30).
...
-file("/home/user/.kerl/erlang/27.2/lib/parsetools-2.6/include/leexinc.hrl", 14).
...
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.erl", 400).
yystate() -> 24.

yystate(27, Ics, Line, Col, Tlen, _, _) ->
    {9,Tlen,Ics,Line,Col};
yystate(26, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(26, Ics, Line, Col, Tlen+1, 14, Tlen);
yystate(26, [9|Ics], Line, Col, Tlen, _, _) ->
    yystate(26, Ics, Line, Col, Tlen+1, 14, Tlen);
yystate(26, Ics, Line, Col, Tlen, _, _) ->
    {14,Tlen,Ics,Line,Col,26};
yystate(25, Ics, Line, Col, Tlen, _, _) ->
    {6,Tlen,Ics,Line,Col};
yystate(24, [124|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(24, [47|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(24, [41|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(24, [40|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(24, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
...
yystate(18, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 15, Tlen);
...
yystate(14, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 15, Tlen);
yystate(14, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(22, Ics, Line+1, 1, Tlen+1, 15, Tlen);
...
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40, C =< 91 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(1, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40, C =< 91 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 95 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
...
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 11).
yyaction_0(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 12).
yyaction_1(TokenChars, TokenLine) ->
     { token, { string, TokenLine, string : substr (TokenChars, 2, length (TokenChars) - 2) } } .

-compile({inline,yyaction_2/2}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 13).
yyaction_2(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 14).
yyaction_3(TokenChars, TokenLine) ->
     { token, reserved_or_identifier (TokenChars, TokenLine) } .

-compile({inline,yyaction_4/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 15).
yyaction_4(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 16).
yyaction_5(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 17).
yyaction_6(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 18).
yyaction_7(TokenLine) ->
     { token, { ';', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 19).
yyaction_8(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 20).
yyaction_9(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 21).
yyaction_10(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 22).
yyaction_11(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 23).
yyaction_12(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_13/1}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 24).
yyaction_13(TokenLine) ->
     { token, { '||', TokenLine } } .

-compile({inline,yyaction_14/0}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 25).
yyaction_14() ->
     skip_token .

-compile({inline,yyaction_15/0}).
-file("/home/user/dev/erl/sqlmig/src/ora_lexer.xrl", 26).
yyaction_15() ->
     skip_token .
-file("/home/user/.kerl/erlang/27.2/lib/parsetools-2.6/include/leexinc.hrl", 344).
